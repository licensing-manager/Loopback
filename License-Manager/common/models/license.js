...
module.exports = function(License) {
    ...
    License.remoteMethod(
      ...
      License.verify = function(license_key, product_s, cb) {
        ...
        License.find(filter, function(ignore, license_model) {
            console.log(license_model);
            if (license_model && license_model.length > 0) {
                ...
                if (exp_date >= today) {
                    ...
                    cb(null, false, "License Expired");
                }
            }
            else {
                cb(null, false, "License does not exist");
            }
