...
let CustomerService = class CustomerService {
    ...
    addCustomer(customer) {
        ...
        this.http.put('http://localhost:3000/api/customers' /*?accescsToken=' + this.accessToken.id */, customer)
...
let CustomerDetailComponent = class CustomerDetailComponent {
    constructor(route, customerService, location) {
        this.route = route;
        this.customerService = customerService;
...
let LoginComponent = class LoginComponent {
    ...
    onSubmit() {
        ...
        this.http.post('http://localhost:3000/api/users/login', this.model)
            .subscribe(response => { this.accesstoken = response; });
    }
};
