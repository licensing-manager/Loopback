(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LicensesService = /** @class */ (function () {
                ...
                LicensesService.prototype.generateLicenses = function (request, customer_name) {
                    var _this = this;
                    this.http.post('http://localhost:3000/api/licenses', request)
                        ...
                        _this.saveData(response, filename);
                    });
                };
                return LicensesService;
            }());
            LicensesService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddPurchaseComponent = /** @class */ (function () {
                function AddPurchaseComponent(customerService, purchaseService, productService, licenseService, dialogRef) {
                    this.customerService = customerService;
                ...
                AddPurchaseComponent.prototype.generateLicenses = function (n, product_s, exp_dt) {
                    var request = {
                        num: n,
                        licenses: [],
                        product: product_s,
